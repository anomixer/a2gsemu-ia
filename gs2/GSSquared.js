...
(() => {
  ...
  async function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "GSSquared.data";
    var REMOTE_PACKAGE_BASE = "GSSquared.data";
    ...
    async function runWithFS(Module) {
      ...
      Module["FS_createPath"]("/resources", "roms", true, true);
      Module["FS_createPath"]("/resources/roms", "apple2", true, true);
      Module["FS_createPath"]("/resources/roms", "apple2_plus", true, true);
      Module["FS_createPath"]("/resources/roms", "apple2e", true, true);
      Module["FS_createPath"]("/resources/roms", "apple2e_enh", true, true);
      Module["FS_createPath"]("/resources/roms", "apple2gs", true, true);
      Module["FS_createPath"]("/resources/roms", "apple2gs_rom3", true, true);
      Module["FS_createPath"]("/resources/roms", "cards", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "applemouseiii", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "diskii", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "keyglu", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "memexp", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "mouse", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "parallel", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "pdblock2", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "pdblock3", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "secondsight", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "ssc", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "tcp", true, true);
      Module["FS_createPath"]("/resources/roms/cards", "videx", true, true);
      Module["FS_createPath"]("/resources", "shaders", true, true);
      Module["FS_createPath"]("/resources", "sounds", true, true);
      Module["FS_createPath"]("/resources", "vdisk", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_GSSquared.data");
      }
      Module["addRunDependency"]("datafile_GSSquared.data");
...
function findWasmBinary() {
  return locateFile("GSSquared.wasm");
}
...
function ___syscall_chmod(path, mode) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(2, 0, 1, path, mode);
  try {
...
function ___syscall_fchmod(fd, mode) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(3, 0, 1, fd, mode);
  try {
    FS.fchmod(fd, mode);
    return 0;
  } catch (e) {
